...
//its just returns requiestedto user notifications
...
// PUT: Update request status to 'accepted'
...
//             return res.status(400).send({ success: false, message: "Invalid Request ID format." });
//         }
...
//             $set: {
//                 status: 'accepted',
//                 updatedAt: new Date().toISOString() // Good for tracking when it was accepted
//             },
//         };
